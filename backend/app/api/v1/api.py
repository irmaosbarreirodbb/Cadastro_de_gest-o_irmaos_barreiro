...
from app.api.v1.endpoints import auth, colaboradores, documentos_pessoas_juridicas, funcionarios, diaristas, pessoas_juridicas, recibos, permissoes_trabalho, epis, exames
